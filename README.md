...
- フォルダ編集画面でアプリを検索
- ホーム画面のメニューから各種操作
- デスクトップに時計・日付ウィジェットを表示（Android標準ウィジェットとして登録）
- アプリ一覧の長押しからフォルダを選択してお気に入り登録
- Nova Launcherのアイコン長押し、またはホーム画面のウィジェット追加から時計・日付ウィジェットを配置
- ホーム画面にお気に入りを4列表示
- 既定のホームアプリ選択画面を開く
- ダークテーマ
- アプリ一覧の再読込
...
## 時計・日付ウィジェットの使い方
1. Nova Launcherを既定のホームアプリに設定する
2. ホーム画面の空いている場所を長押しして「ウィジェット」を開く
3. 「Nova Launcher」から「時計・日付」を追加する

Nova Launcherのアプリ一覧でNova Launcherを長押ししても、同じウィジェットを配置できます。
